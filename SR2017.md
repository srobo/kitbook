...
There are four top-level tasks that can (and should) be carried out in parallel: arena construction, staging area construction, display assembly and game prop construction.
...
#### Procedure
 ...
 1. The following steps can be carried out in parallel. Two people work on each step.
    1. Apply spikes (small bits of tape on the floor) for the game props to allow them to be quickly repositioned at the end of a match. **[30 mins]**
    1. Apply the A/B markers to the outside of the arena walls. **[15 mins]**
    1. (After the pair complete the above step) Place the crowd-control barrier around the arenas. **[15 mins]**
