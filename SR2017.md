...
The tokens are not associated with corners/robots in any way this year, so their colouring should not imply any association. For this reason the tokens will be brown (A tokens), blue (B tokens) and red (C tokens).
