...
Once you have finished scoring, you should compare your score-sheet to that of the other marshal in order to pick up any mistakes. One of you should then drop your completed score sheet at the score entry desk which will be near the arenas. You must return promptly to the arena in case you need to be found for further scoring questions, and begin resetting the arena for the next match.
