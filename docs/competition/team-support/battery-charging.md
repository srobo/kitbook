...
Every volunteer performing the Battery Charging role must have read this document fully. If there are any doubts must be discussed with the Volunteer Coordinator ASAP.
...
If at any point you have any doubts about safety, immediately summon the Health & Safety Coordinator via [Helpdesk](/competition/team-support/helpdesk).
...
All of the battery chargers will be set-up and ready to use. Before a battery is connected the screen must display `LiPo BALANCE 2.2A 11.1V(3S)`. If it displays anything else then please do not use it and ask [Helpdesk](/competition/team-support/helpdesk) to summon the head helpdesker. Batteries are charged as follows:
 ...
 1. Hold down the Start/Enter button for about 3 seconds until the screen displays `R:3SER S:3SER CONFIRM(ENTER)`. If both numbers are not 3 then disconnect the battery and summon the Head Helpdesker.
